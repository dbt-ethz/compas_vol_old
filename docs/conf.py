...
project = 'compas_vol'
copyright = 'Digital Building Technologies - ETH Zurich'
...
def linkcode_resolve(domain, info):
    ...
    if not package.startswith('compas_vol'):
        return None
...
html_theme_options = {
    "package_name"    : "compas_vol",
    "package_title"   : project,
    "package_version" : release,
    "package_author"  : "Mathias Bernhard",
    "package_docs"    : "https://dbt-ethz.github.io/compas_vol/",
    "package_repo"    : "https://github.com/dbt-ethz/compas_vol",
    "package_old_versions_txt": "https://dbt-ethz.github.io/compas_vol/doc_versions.txt"
}
